	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-35 p-b-50">
				<form class="login100-form validate-form" action="/postregisagen" method="POST">
					{{csrf_field()}}
                	...
                	@endif
					<label style="font-size: 12px">Broker Agen <a style="color: red">*</a> </label>
                    <div class="wrap-input100 validate-input" data-validate = "Masukkan nama broker perusahaan Anda / Tulis Independent Agen">
						
						<input class="input100 @error('broker_agen') is-invalid @enderror" type="text" name="broker_agen" placeholder=" Broker Agen" value="{{ old('broker_agen') }}">
